                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="bg-second-100 sm:text-sm rounded-lg block w-full p-2.5" placeholder="name@gmail.com" required="">
                        </div>
                        <div>
                        ...
                        <p class="text-sm font-light text-white text-center">
                            Don't have an account? <a href="/sign-in" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign Up Here</a>
                        </p>
                    </form>
                </div>
            </div>
